...
<template>
    <AuthenticatedLayout>
        <form @submit.prevent="submit" class="pt-[100px] pb-[100px] pr-[100px] pl-[100px]">
            <!-- ----------------------TITLE---------------------- -->
            <div class="mb-3">
                <label for="title" class="block text-gray-700 font-bold mb-2 text-lg">Nome Appartamento</label>
                <input type="text" id="title" name="title" v-model="newApartment.title" placeholder="Inserisci il nome..."
            ...
            <!-- ----------------------COVER IMG---------------------- -->
            <div class="mb-3 pt-[45px]">
                <label for="cover_img" class="block pb-2 font-medium text-gray-700 text-lg">Immagine di copertina</label>
                <input @input="newApartment.cover_img = $event.target.files[0]" required type="file" name="cover_img"
