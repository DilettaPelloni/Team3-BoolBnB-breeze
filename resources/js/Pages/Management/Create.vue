            ...
            axios
                .get(
                    `https://api.tomtom.com/search/2/geocode/${encodeURIComponent(
                        address
                    )}.json?key=waiWTZRECqzNGHIbW83D94YfzNv1Uc1e&language=it-IT&countrySet=IT&limit=5`
                )
                .then((resp) => {
    ...
    <AuthenticatedLayout>
        ...
        >
            ...
            <div class="mb-3 pt-[45px]">
                ...
                />
                <div
                    v-if="newApartment.errors.address"
                ...
                <div
                    v-if="addresses.length > 0 && showAddresses"
                ...
                >
                    <ul class="w-[500px]">
                        <li
                            ...
                            :key="address.id"
                            class="border-b border-gray-200 w-[500px]"
                        >
                            <p
                                class="hover:bg-gray-100 p-3"
            ...
            <div class="text-center">
                <button
                    ...
                    class="mt-[65px] px-4 py-2 rounded-full pink text-white"
                >
