        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('welcome')" class="block h-[50px]">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 md:flex">
                                ...
                                <NavLink :href="route('gestione-appartamenti.index')"
                                    :active="route().current('gestione-appartamenti.index')">
                                    Appartamenti
                                </NavLink>
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('logout')" method="post" as="button" class="text-center">
                                            Log Out
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="md:hidden">
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('gestione-appartamenti.index')"
                            :active="route().current('gestione-appartamenti.index')">
                            Appartamenti
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('sponsorship')" :active="route().current('sponsorship')">
                            Sponsorizzazioni
                        </ResponsiveNavLink>
                    </div>
